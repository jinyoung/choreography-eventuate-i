<template>
    <v-card outlined>
        ...
        <v-card-text>
            <div>
                <String label="CurrencyId" v-model="item.currencyId" :editMode="editMode" @change="change" />
            </div>
            <div>
            ...
            <div>
                <String label="HolderId" v-model="item.holderId" :editMode="editMode" @change="change" />
            </div>
        </v-card-text>
